...
>- 🥽 **Safety glasses**:  Proper safety glasses are required at all times,f for anyone within chip throwing distance
...
> 1. Check the auto oiler, and manual oiling instructions.
> 1. Verify there is oil in the powerfeed.
<!-- {blockquote:.is-info} -->
## Operation checklist

> 1. Use coolant, please
<!-- {blockquote:.is-info} -->
...
> 1. Use the vaccum labeled 'for metal' to clean up. Do not use the wood vaccum.
> 1. Lock up the toolbox and the breaker padlock when done
<!-- {blockquote:.is-info} -->
