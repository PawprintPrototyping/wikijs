...
![80W Omtech Laser Cutter](/80w-laser.jpg =x500)
...
> - 🥽 **Safety glasses**:  Polycarbonate, acrylic, or any prescription glasses will offer protection from IR light. Special laser protection eyewear is in the laser computer drawer, mostly used for maintenance.
...
> Prohibited Operations {.is-warning}
...
> The following materials should _NEVER_ be placed into the laser cutter. {.is-warning}
...
> 1. Take care to select appropriate power/speeds settings to avoid combustion. Always start jobs with lowest power if unsure.
<!-- {blockquote:.is-info} -->
...
> **Max power level:** The manufacturer does not recommend surpassing 70% power for any project.  You should get desired cuts or engraving quality with no more than 50-60% max power.  Running above 70% max power constantly will shorten the lifespan of the laser tube. {.is-warning}
...
|Nimbus       | Geo          | 2026-02-03     |
|Cameron      | Geo          | 2026-02-03     |
|Kiyo         | Rechner      | 2026-02-17     |
|Awe          | Rechner, Geo | 2026-06-23     |
|Yuril        | Rechner      | 2026-07-28     |
|Ziggy        | Rechner      | 2026-07-28     |
