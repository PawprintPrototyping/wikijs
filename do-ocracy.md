...
### Don't Be a Dick About It Either
...
### Do-ers Decide, Non-Do-ers Stand Aside
...
- **Don't spend the organization's money** without membership approval. If a project needs funding, bring it up at a general body meeting or send your formal proposal to secretary@.
- **Don't throw away other people's stuff.** If something looks like junk but might belong to someone, ask in the Telegram group first. Items with [green parking tickets](./leaving-stuff-at-the-space.md) are spoken for until they expire.  Items with unknown ownership may get a red parking ticket and either be absorbed into general space use, sold at the [Electronics Flea Market](https://www.electronicsfleamarket.com/), or discarded.
- **Don't make irreversible changes to shared infrastructure** (electrical, plumbing, network, walls) without discussing it first. Reversible improvements are generally fair game.
- **Don't override someone else's active project.** If someone is clearly in the middle of something, coordinate rather than steamroll.
...
1. Fizz asks around if anyone would feel negative about the bike shed being painted pink. No one objects.
2. Fizz paints the bike shed pink.

Or, the more realistic version:

1. Fizz paints the bike shed pink.
2. Buzz is unhappy — she helped build that bike shed and wasn't consulted.
3. Buzz politely talks to Fizz about it. Fizz realizes that other people sharing the space have feelings too.
4. They agree to repaint it blue.

## Credit

Do-ocracy as a hackerspace governance principle was popularized by [Noisebridge](https://www.noisebridge.net/) in San Francisco and has since been adopted by hackerspaces worldwide.  Much of this article was adapted from [the Noisebridge article on Do-ocracy](https://www.noisebridge.net/wiki/Do-ocracy).  The concept is also well-documented in the [Hackerspace Blueprint](https://hackerspace.design/) and [CommunityWiki](https://communitywiki.org/wiki/DoOcracy).  We've adapted it to fit Pawprint's culture and structure.
